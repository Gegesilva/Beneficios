    ...
    <div class="month-card">
      <table>
        ...
        $sql = "SELECT DISTINCT
                    ...
                    ISNULL(ini.VALOR_INI, 0) + ISNULL(conc.VALOR_CONCEDIDO, 0) - ISNULL(util.VALOR_UTILIZADO, 0) - ISNULL(expir.VALOR_EXPIRADO, 0) AS VALOR_FINAL
                  FROM 
                      Beneficios a
...
$params = [$DataIni, $DataIni, $DataFim];
